...
namespace linalg {
  namespace detail {
    ...
    void vector_engine_addition_helper(const ENG1 &lhs, const ENG2 &rhs, ENG3 &src)
    {
    ...
    template<class ENG1, class ENG2, class ENG3>
    void vector_engine_multiplication_helper(const ENG1 &lhs, const ENG2 &rhs, ENG3 &src)
    {
      using type = element_promotion_t<typename ENG1::type, typename ENG2::type>;
      using size_type = element_promotion_t<typename ENG1::size_type, typename ENG2::size_type>;
      size_type index = 0;
    ...
    auto vector_engine_addition(const ENG1 &lhs, const ENG2 &rhs)
    {
    ...
    template<class ENG1, class ENG2>
    auto vector_engine_subtraction(const ENG1 &lhs, const ENG2 &rhs)
    {
      using type = element_promotion_t<typename ENG1::type, typename ENG2::type>;
      using size_type = element_promotion_t<typename ENG1::size_type, typename ENG2::size_type>;
    ...
    template<class ENG1, class ENG2>
    auto vector_engine_multiplication(const ENG1 &lhs, const ENG2 &rhs)
    {
      auto src = vector_engine_promotion(lhs, rhs);
      src.fill(1);
