...
namespace atomic { namespace detail {
...
template<typename T> static inline void log_argument(T /* t */) {}
template<typename... Args> static inline void log(Args&&... /* args */) {}
template<typename... Args> static inline void trace(Args&& ... /* args */) {}
