...
template<typename T, std::size_t D> struct line_segment;
template<typename T> using line_segment2 = line_segment<T,2>;
template<typename T> using line_segment3 = line_segment<T,3>;
template<typename T> using line_segment4 = line_segment<T,3>;
